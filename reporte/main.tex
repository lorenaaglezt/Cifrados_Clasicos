...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small Criptografía y Seguridad}
\fancyhead[R]{\small Cifrados Clásicos}
\fancyfoot[C]{\thepage}
...
El cifrado César es un cifrado de sustitución. De acuerdo a \cite{notas_galaviz}, si en un mensaje original se
...
necesario separarlos del diccionario y aplicar una lógica distinta por aparte.

Por último, otro reto enfrentado fue al momento de implementar la codificación Base64, nuestra versión inicial del programa tardaba
mucho tiempo y se fue modificando poco a poco para que pudiera terminar el programa. Antes se habían implementado muchos ciclos anidados
que retardaban mucho el proceso (pues funcionaba con entradas pequeñas pero conforme aumentaba, tardaba mucho más), por lo que nos 
atoramos en esta parte para que se pudiera decodificar exitosamente.

Como resultado pudimos implementar el programa antes desarrollado y aprender sobre estos cifrados clásicos y la codificación Base64.
...
\bibitem{notas_galaviz}
Galaviz Casas, J.
\textit{Introducción a la Criptología}.
2010.
Disponible en: \url{https://drive.google.com/file/d/1FxSX0-ymteWoxSPeR_3w7Mxd2H11bIRe/view}

\bibitem{medium_article}
Jens@Fivesec.
\textit{Revisiting the Basics: Implementing Base64 from Scratch in pure C}.
Medium, 2024.
Disponible en: \url{https://medium.com/@js_9757/revisiting-the-basics-implementing-base64-from-scratch-in-pure-c-c6985fb08420}

\bibitem{base64}
Base64 Algorithm Description.
Disponible en: \url{https://www.sunshine2k.de/articles/coding/base64/understanding_base64.html}

\bibitem{magic_bytes}
Magic Bytes.
Disponible en: \url{https://en.wikipedia.org/wiki/List_of_file_signatures}

\bibitem{magic_bytes2}
Identificador de Archivos (Magic Bytes).
Disponible en: \url{https://tool.lu/es_ES/magicbytes/}
