...
\begin{itemize}
    ...
    \item \texttt{verificar(datos)}: Envuelve la llamada a \texttt{detectar\_formato} de \texttt{magic\_bytes.py}.
    Recibe la secuencia de bytes resultante de un intento de descifrado y devuelve el formato detectado,
    o \texttt{None} si no coincide ninguna firma conocida.
